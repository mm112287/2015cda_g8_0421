...
class MAN(object):
    ...
    <a href="man24">建立本體</a><br />
    <a href="man49">組裝左手和手腕</a><br />
    <a href="man29">組裝右手和手腕</a><br />
    <a href="man51">組裝頭</a><br />
    <a href="man10">組裝帽子</a><br />
    <a href="man45">組裝褲子</a><br />
    <a href="man52">組裝左右腳</a><br />
...
axis_plane_assembly(session, assembly, transf, first_featID, 5,"LEGO_HAT.prt", "A_2", "TOP", "A_2", "FRONT"); 
    // regenerate 並且 repaint 組立檔案
    assembly.Regenerate (void null);
    session.GetModelWindow (assembly).Repaint();    
    </script>
...
var components = assembly.ListFeaturesByType(true, pfcCreate ("pfcFeatureType").FEATTYPE_COMPONENT);
    // 此一 featID 為組立件中的第一個零件編號, 也就是樂高人偶的 body
var first_featID = components.Item(0).Id;
// 利用函式呼叫組立右手 ARM, 組立增量次序為 3
axis_plane_assembly(session, assembly, transf, first_featID , 0, "LEGO_ARM_RT.prt", "A_13", "DTM1", "A_4", "DTM1");
// 利用函式呼叫組立右手 HAND, 組立增量次序為 4
axis_plane_assembly(session, assembly, transf, first_featID, 3, "LEGO_HAND.prt", "A_2", "DTM2", "A_1", "DTM3");
...
// Body 組立面為 DTM4, DTM5, DTM6
// WAIST 組立面為 DTM1, DTM2, DTM3, 組立增量次序為 6, 與 body 採三面 mate 組立
three_plane_assembly2(session, assembly, transf, first_featID, 0, "LEGO_WAIST.prt", "DTM4", "DTM5", "DTM6", "DTM1", "DTM2", "DTM3");
    // regenerate 並且 repaint 組立檔案
    assembly.Regenerate (void null);
    session.GetModelWindow (assembly).Repaint();    
    </script>
...
axis_plane_assembly(session, assembly, transf, first_featID, 0, 
                              "LEGO_ARM_LT.prt", "A_9", "DTM2", "A_4", "DTM1");
// 利用函式呼叫組立左手 HAND, 組立增量次序為 4
axis_plane_assembly(session, assembly, transf, first_featID, 1, "LEGO_HAND.prt", "A_2", "DTM2", "A_1", "DTM3");
    // regenerate 並且 repaint 組立檔案
    assembly.Regenerate (void null);
    session.GetModelWindow (assembly).Repaint();    
    </script>
...
// BODY id 為 featID+0, 以 A_2 及  DTM3 約束
// HEAD 則直接呼叫檔案名稱, 以 A_2, DTM2 約束
axis_plane_assembly(session, assembly, transf, first_featID, 0, "LEGO_HEAD.prt", "A_2", "DTM3", "A_2", "DTM2");
    // regenerate 並且 repaint 組立檔案
    assembly.Regenerate (void null);
    session.GetModelWindow (assembly).Repaint();    
    </script>
...
var first_featID = components.Item(0).Id;
// 右腳
axis_plane_assembly(session, assembly, transf, first_featID, 7, "LEGO_LEG_RT.prt", "A_8", "DTM4", "A_10", "DTM1");
// 左腳
axis_plane_assembly(session, assembly, transf, first_featID, 7, "LEGO_LEG_LT.prt", "A_8", "DTM5", "A_10", "DTM1");
    // regenerate 並且 repaint 組立檔案
    assembly.Regenerate (void null);
    session.GetModelWindow (assembly).Repaint();    
    </script>
